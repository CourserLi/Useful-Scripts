...
"""
# 测试号，需要运行 test1.py 获取
我自己 wx_id：wxid_6bzbnhwotufq12
群聊 room_id：25644933641@chatroom
"""
...
def test():
    ...
    # print(wb.get_member_nick('wxid_6bzbnhwotufq12', '25644933641@chatroom'))
    print(wb.send_pic(to='25644933641@chatroom', path='C:\\Users\\Administrator\\Desktop\\wechat\\pic\\yy.jpg'))
    print(wb.send_attach(to='25644933641@chatroom', path='C:\\Users\\Administrator\\Desktop\\wechat\\pic\\yy.jpg'))
    print(wb.send_txt_msg(to='wxid_6bzbnhwotufq12', content='发送个人消息'))
    print(wb.send_txt_msg(to='25644933641@chatroom', content='发送群消息'))
    print(wb.send_at_msg(wx_id='wxid_6bzbnhwotufq12', room_id='25644933641@chatroom', content='测试一下at消息', nickname='某个人'))
    print('测试完成')
